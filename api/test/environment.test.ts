...
describe('environment validation', () => {
  it('accepts a valid development environment', () => {
    expect(loadEnvironment({ NODE_ENV: 'development', API_PORT: '4000', WEB_URL: 'http://localhost:3000', DATABASE_URL: 'postgresql://user:pass@localhost:5432/test', REDIS_URL: 'redis://localhost:6379', FIREBASE_PROJECT_ID: 'test-project', PAYMENT_PROVIDER_KEY: 'RAZORPAY', RAZORPAY_KEY_ID: 'test-key', RAZORPAY_KEY_SECRET: 'test-secret', RAZORPAY_WEBHOOK_SECRET: 'test-webhook-secret', PAYMENT_ORDER_PROVISIONING_LEASE_SECONDS: '60', SESSION_IDLE_TTL_SECONDS: '3600', SESSION_ABSOLUTE_TTL_SECONDS: '7200' })).toMatchObject({ API_PORT: 4000 });
  });
