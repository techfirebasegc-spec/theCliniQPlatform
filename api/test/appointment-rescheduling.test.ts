...
class Appointments implements AppointmentRepository {
  ...
  async lockBookable(): Promise<BookableService> { return { provider, serviceOfferingId: 'offering', versionId: 'version', priceId: 'price', currency: 'INR', priceAmountMinor: 10_000n, bookingTenantId: null, timezone: 'Asia/Kolkata', slotDurationSeconds: 1800, durationSeconds: 1800, bufferBeforeSeconds: 0, bufferAfterSeconds: 0, capacity: 1, bookingLeadSeconds: 60, bookingHorizonSeconds: 86_400 * 14, holdSeconds: 600, rules: [rule], exceptions: [] as AvailabilityException[] }; }
