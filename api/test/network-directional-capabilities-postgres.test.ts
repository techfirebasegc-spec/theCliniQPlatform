...
async function seed(target: Pool) {
  ...
  await target.query("INSERT INTO network_connections (id,connection_kind,clinic_left_id,clinic_right_id,status,initiated_by_account_id,recipient_party_kind,initiator_party_kind,initiator_clinic_id,accepted_at) VALUES ($1,'CLINIC_CLINIC',$2,$3,'ACCEPTED',$4,'CLINIC','CLINIC',$2,current_timestamp)", [clinicClinicConnection, clinicA, clinicB, clinicAccountA]);
}
